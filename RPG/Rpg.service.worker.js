...
const CACHE_NAME = "Rpg-cache";
const OFFLINE_URL = "Rpg.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["Rpg.html","Rpg.js","Rpg.wasm","Rpg.pck","Rpg.offline.html","Rpg.icon.png","Rpg.apple-touch-icon.png"];
